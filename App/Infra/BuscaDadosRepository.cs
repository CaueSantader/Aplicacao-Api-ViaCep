...
{
    public class BuscaDadosRepository : ModeloRelatorio
    {

        public List<ModeloRelatorio> Buscadados()
        {
            ...
            try
            {
                ...
                cmd.CommandText = $@"select cep_str, logradouro_str, complemento_str, bairro_str, localidade_str, uf_str, ibge_str, gia_str, ddd_str, siafi_str, tstamp from es_viacep";
